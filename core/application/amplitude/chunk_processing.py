...
from core.application.amplitude.persistence import save_amplitudes_and_meta
from core.application.amplitude.runtime import (
    DEFAULT_TASK_RETRIES,
    _tqdm,
    _yield_futures_with_results,
)
from core.infrastructure.adapters.cunufft_wrapper import (
...
def _process_chunk_id(
    ...
    if quiet_logs:
        for name in (
            __name__,
            "core.infrastructure.persistence.database_manager",
            "DatabaseManager",
            "core.application.point_selection.point_data",
            "PointDataProcessor",
            "RIFFTInDataSaver",
        ):
            try:
