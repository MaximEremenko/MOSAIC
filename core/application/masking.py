...
from core.application.common import first_present, normalize_post_mode
from core.strategies.mask_strategies import EqBasedStrategy
from core.strategies.shape_strategies import CircleShapeStrategy, IntervalShapeStrategy
...
class MaskStrategyService:
    def build(self, dim: int, peak_info: dict, post_mode: str = "displacement"):
        ...
        if normalize_post_mode(post_mode) == "displacement":
            condition = """
