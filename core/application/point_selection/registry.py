...
from core.application.point_selection.central import CentralPointProcessor
from core.application.point_selection.from_average import FromAveragePointProcessor
