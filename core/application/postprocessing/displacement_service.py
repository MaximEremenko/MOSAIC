...
from core.application.postprocessing.decoder_service import (
    apply_decoder,
    build_feature_sets,
    ensure_decoder,
)
from core.application.postprocessing.grid import compute_hkl_max_from_intervals
from core.application.postprocessing.io import write_displacements_csv
...
def compute_and_save_displacements(
    ...
    *,
    ...
    data, amplitudes, rifft_space_grid = load_chunk_amplitudes_and_grid(
        processor,
        chunk_id=chunk_id,
