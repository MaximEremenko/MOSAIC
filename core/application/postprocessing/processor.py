...
from core.application.postprocessing.decoder_cache import build_decoder_cache_path
from core.application.postprocessing.displacement_service import (
    compute_and_save_displacements,
)
from core.application.postprocessing.loader import load_amplitudes_and_generate_grid
from core.application.postprocessing.site_intensity_service import (
    compute_and_save_site_intensities,
)
from core.application.postprocessing.state import build_postprocessing_processor_state
from core.application.postprocessing.window import filter_from_window as filter_from_window_impl
...
class PointDataPostprocessingProcessor:
    ...
    def load_amplitudes_and_generate_grid(self, chunk_id, point_data_list, rifft_saver):
        return load_amplitudes_and_generate_grid(self, chunk_id, point_data_list, rifft_saver)
