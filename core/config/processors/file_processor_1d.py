...
from core.config.parsers.data_1d_parser import DataParser1D
from core.config.readers.file_reader1d import FileReader1D
import pandas as pd
...
class ConfigurationFileProcessor1D(IConfigurationFileProcessor):
    ...
    def process(self):
        ...
        self.data[['X']] = apply_lattice_vectors(self.data[['X']].values, self.vectors)
        self.data[['Xav']] = apply_lattice_vectors(self.data[['Xav']].values, self.vectors)
