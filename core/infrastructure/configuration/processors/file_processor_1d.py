...
from core.infrastructure.configuration.parsers.data_1d_parser import DataParser1D
from core.infrastructure.configuration.readers.file_reader1d import FileReader1D
import pandas as pd
