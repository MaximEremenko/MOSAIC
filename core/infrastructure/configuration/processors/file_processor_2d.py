...
from core.infrastructure.configuration.parsers.data_2d_parser import DataParser2D
from core.infrastructure.configuration.readers.file_reader2d import FileReader2D
import pandas as pd
