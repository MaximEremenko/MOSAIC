...
def main():   
    ...
    if chemical_filtered and run_post:
        log.warning(
            "chemical_filtered_ordering is enabled: postprocessing currently decodes displacements; "
            "set rspace_info.run_postprocessing=false to skip."
        )
    if run_post:
